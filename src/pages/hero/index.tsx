...
export default function Hero() {
    ...
    return (
      ...
      <HeroHighlight className="flex flex-col justify-center items-center space-y-2">
        ...
        >
          <button  onClick={navigateToOpinionCollection} className="p-[3px] relative mt-5">
          ...
          <p className="text-center text-neutral-700 dark:text-white">Already a user? <Link href="/login">Log in</Link></p>
        </motion.h1>      
        </HeroHighlight>
